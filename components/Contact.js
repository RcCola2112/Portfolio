      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        <div>
          ...
          <div className="mt-4 text-sm text-gray-700 dark:text-gray-300 space-y-2">
            <div className="flex items-center gap-2"><FiPhone /> <span>Tel: (+63) 936-269-5356</span></div>
            <div className="flex items-center gap-2"><FiMail /> <a href="mailto:denvermartinez2112@gmail.com" className="hover:text-primary dark:hover:text-white">denvermartinez2112@gmail.com</a></div>
          </div>
